    ...
    <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-200 p-3 sm:p-4 md:p-6">
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <button
                ...
                className="min-w-[44px] min-h-[44px] w-11 h-11 sm:w-10 sm:h-10 flex items-center justify-center border border-gray-300 rounded-lg hover:bg-gray-50 active:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                aria-label="کاهش تعداد"
              >
                <Minus className="w-4 h-4 sm:w-4 sm:h-4" />
              </button>
              <span className="min-w-[44px] w-12 sm:w-14 text-center font-semibold text-base sm:text-lg flex items-center justify-center">
                {isUpdating ? (
        ...
        <button
          ...
          disabled={isUpdating}
          className="flex-shrink-0 self-start sm:self-auto min-w-[44px] min-h-[44px] flex items-center justify-center text-red-600 hover:text-red-700 hover:bg-red-50 disabled:opacity-50 p-2 sm:p-1 rounded-lg transition-colors"
