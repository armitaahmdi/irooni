...
import { useGetArticlesQuery } from "@/store/api/productsApi";

import "swiper/css";
import "swiper/css/free-mode";

const BlogSection = () => {
  const { data, isLoading, error } = useGetArticlesQuery({ limit: 10 });
  ...
  const posts = data?.success && Array.isArray(data.data)
