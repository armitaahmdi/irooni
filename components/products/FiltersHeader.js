...
export default function FiltersHeader({
  ...
  return (
    <div className="w-full bg-gradient-to-br from-[#286378] via-[#2d7489] to-[#43909A] px-4 sm:px-6 py-4 sm:py-5 relative overflow-hidden hover:from-[#2d7489] hover:via-[#286378] transition-all duration-300">
      ...
      <div className="relative flex items-center justify-between gap-3">
        ...
        >
          <span className="flex items-center gap-3">
            <span className="p-2 bg-white/20 rounded-lg backdrop-blur-sm group-hover:bg-white/30 transition-all duration-200">
              <Filter className="w-5 h-5 text-white" />
            </span>
            <span className="text-lg sm:text-xl font-bold text-white drop-shadow-sm">فیلترها</span>
          ...
          <span className="p-1.5 bg-white/20 rounded-lg backdrop-blur-sm group-hover:bg-white/30 transition-all duration-200">
            {isFiltersExpanded ? (
