        ...
        <div className="text-center py-12 sm:py-16">
          <div className="relative inline-flex items-center justify-center mb-6">
            ...
            <div className="relative bg-gradient-to-br from-blue-50 to-indigo-50 rounded-full p-6 border-4 border-blue-100">
              <Package className="w-16 h-16 sm:w-20 sm:h-20 text-blue-400" aria-hidden="true" />
            </div>
          </div>
          ...
          <p className="text-base sm:text-lg text-gray-600 mb-8">
            {orderFilter ? "لطفاً فیلتر دیگری را انتخاب کنید" : "برای شروع خرید به فروشگاه بروید"}
          </p>
          {orderFilter && (
            <button
              onClick={() => setOrderFilter(null)}
              className="min-h-[44px] inline-flex items-center justify-center px-6 sm:px-8 py-3 bg-gradient-to-r from-[#286378] to-[#43909A] text-white rounded-xl hover:from-[#43909A] hover:to-[#286378] font-semibold transition-all duration-300 shadow-md hover:shadow-lg active:scale-[0.98] text-base sm:text-lg"
              aria-label="نمایش همه سفارش‌ها"
            >
              نمایش همه سفارش‌ها
            </button>
          )}
          {!orderFilter && (
            <Link
              href="/"
              className="min-h-[44px] inline-flex items-center justify-center px-6 sm:px-8 py-3 bg-gradient-to-r from-[#286378] to-[#43909A] text-white rounded-xl hover:from-[#43909A] hover:to-[#286378] font-semibold transition-all duration-300 shadow-md hover:shadow-lg active:scale-[0.98] text-base sm:text-lg"
              aria-label="شروع خرید از فروشگاه"
            >
              شروع خرید
            </Link>
          )}
